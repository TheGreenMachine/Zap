...
public class Shooter extends Subsystem implements PidProvider {
    ...
    public static final int TARMAC_TAPE_VEL = (int) factory.getConstant(NAME, "tarmacTapeVel"); // Trench this also worked from initiation
    public static final int LAUNCHPAD_VEL = (int) factory.getConstant(NAME, "launchpadVel");
