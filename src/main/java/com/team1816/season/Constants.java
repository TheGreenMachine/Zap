    ...
    public static final HashMap<Integer, Double[]> fieldTargets = new HashMap<>() {
        {
            ...
            // blue alliance side - - Double[] -> Pose3d(x,y,z, new Rotation3D());
            put(0, new Double[] { 0.000, 7.510, 0.886 }); // Blue Hangar Panel

            put(1, new Double[] { 3.320, 5.588, 1.725 }); // upper hangar target - Blue Hangar Truss - Hub

            put(2, new Double[] { 3.072, 5.249, 1.376 }); // lower hangar target - Blue Hangar Truss - Side

            put(3, new Double[] { 0.008, 5.966, 1.376 }); // Blue Station 2 Wall

            put(4, new Double[] { 0.008, 3.575, 1.376 }); // Blue Station 3 Wall

            // blue human player station
            put(5, new Double[] { 0.125, 1.656, 0.891 }); // Blue Terminal Near Station

            put(6, new Double[] { 0.877, 0.879, 0.891 }); // Blue Mid Terminal

            put(7, new Double[] { 1.619, 0.095, 0.891 }); // Blue End Terminal

            // red alliance side
            put(10, new Double[] { 16.460, 0.589, 0.886 }); // Blue Hangar Panels
