...
public class ThreeBallAutoB implements PathContainer {
    ...
    public List<Pose2d> buildWaypoints() {
        return List.of(
            ...
            new Pose2d(317, 16, Rotation2d.fromDegrees(7))
        );
    }

    @Override
    public List<Rotation2d> buildHeadings() {
        return List.of(Rotation2d.fromDegrees(-135), Rotation2d.fromDegrees(-135), Rotation2d.fromDegrees(-15), Rotation2d.fromDegrees(7));
    }
