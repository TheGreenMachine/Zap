...
public class GreenSensorFactory {
    ...
    private void configureColorSensorV3(ColorSensorV3 sensor) {
        configureColorSensorV3(sensor, ColorSensorV3.ColorSensorResolution.kColorSensorRes16bit, ColorSensorV3.ColorSensorMeasurementRate.kColorRate25ms, ColorSensorV3.GainFactor.kGain3x);
    }

    private void configureColorSensorV3(ColorSensorV3 sensor, ColorSensorV3.ColorSensorResolution res, ColorSensorV3.ColorSensorMeasurementRate mr, ColorSensorV3.GainFactor gf) {
